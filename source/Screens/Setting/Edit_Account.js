...
var that;
 class Edit_Account extends React. Component {
    ...
    constructor(props){
     ...
     componentDidMount(){
        that = this;
        const {description, website, address, cover_image,user_name,
    ...
    onEditPress=()=>{
        ...
        const { description, website,address, coverImage,email,phone_number,company_name,user_name} = this.state;
        // console.log(email,phone_number,company_name,user_name,description);
        ...
        // if(coverImage !== `${BASE_URL}${this.props.user.cover_image}`){
    ...
    render(){
        ...
        // const {email} = user;
        const { email,phone_number,address, user_name,company_name,description, coverImage, website, loading} = this.state;
