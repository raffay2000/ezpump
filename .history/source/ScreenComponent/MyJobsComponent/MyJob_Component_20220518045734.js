...
export const My_Job_Component = ({Heading, onPress, Date, IsService, Service, Duration, distance, status, statusColor}) => {
        return(
                <TouchableOpacity onPress={onPress} style={styles.main} >
                    ...
                    <View style={[styles.TxtAlign, {marginTop:hp("1%")}]} >
                            ...
                            <Text style={[styles.Txt,{marginLeft: hp('2.5%')}]} > {Duration}  </Text>
                        </View>

                    <View style={styles.Container} >
                        <View style={styles.TxtAlign} >
                            <MaterialIcon name="map-marker-distance" color="#00000029" size={hp("3%")} />
