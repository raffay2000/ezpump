    ...
    return(
        <TouchableOpacity style={styles.container}>
            ...
            <View style={styles.row}>
                <Icon name="truck" color={"black"}/>
                <Text style={styles.text}>Pump Type - {pump}</Text>
            </View>
            <View style={styles.row}>
                <Icon2 name="briefcase" color={"black"}/>
                <Text style={styles.text}>Job Type - {job}</Text>
            </View>
            <View style={styles.row}>
                <Icon style={{padding: hp('0.75%'), backgroundColor: 'lightgray', borderRadius: 100}} name="world" color={'#808080'}/>
