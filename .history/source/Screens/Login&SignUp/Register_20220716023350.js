    ...
    Register_Now = () => {
        ...
        if(
           ...
           this.setState({error:true})
            ...
            console.log(username, name, description, this.state.ImageSource, this.state.website_name, this.props.route.params.userType, this.props.route.params.isChecked, this.props.route.params.email, this.props.route.params.password, this.props.route.params.phone);
        }
    }
