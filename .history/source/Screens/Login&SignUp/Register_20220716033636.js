...
import { setDescription, setName, setUsername,registerStepTwo } from "../../Redux/Action/AuthAction";
import {launchImageLibrary,} from 'react-native-image-picker';
 class Register extends Component{
    ...
    Register_Now = async() => {
        ...
        const {website_name,ImageSource} = this.state;
        const {isChecked} = this.props.route.params;
        ...
        if(
           ...
           this.setState({error:true})
            ...
            // console.log(username, name, description, this.state.website_name, this.props.route.params.userType, this.props.route.params.isChecked, this.props.route.params.email, this.props.route.params.password, this.props.route.params.phone);
            const userCreated=await this.props.registerStepTwo(website_name,ImageSource,isChecked)
            if(userCreated){
            return this.props.navigation.navigate("PhoneVerification")
            }else{
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        registerStepTwo: (website_name,isChecked) => dispatch(registerStepTwo(website_name,isChecked)),
