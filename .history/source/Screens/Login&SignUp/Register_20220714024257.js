           ...
           <ScrollView style={{flex:1, backgroundColor:primary, padding:hp("2%") }} >
                <View style={styles.main}> 
                    ...
                    <TouchableOpacity style={styles.btn} onPress={this.Select_Img} >
                        <Text style={[styles.Txt, {marginTop:0 , alignSelf:"flex-start", fontSize:hp("2.6%"), lineHeight:hp("2.8%"),color:"#000",paddingLeft:12,backgroundColor:"#fff"}]} >
                            {this.state.ImageSource == "" ? "Select Image" : `Change Image (${this.state.ImageSource.slice(90,1000)})`}
                        </Text>
                    </TouchableOpacity>
