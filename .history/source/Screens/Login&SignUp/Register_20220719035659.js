...
import { setDescription, setName, setUsername,registerStepTwo,setPhone } from "../../Redux/Action/AuthAction";
    ...
    Register_Now = async() => {
        ...
        if(
            ...
            this.state.ImageSource == ""
                ...
                const phone1 = this.props.setPhone(phone);
            // console.log(username, name, description,website_name,email,password,phone,userType);
            await this.props.registerStepTwo(email,password,phone1,userType,website_name,ImageSource,isCheck);
            try {
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        registerStepTwo: (email,password,phone,userType,website_name,ImageSource,isChecked) => dispatch(registerStepTwo(email,password,phone,userType,website_name,ImageSource,isChecked)),
