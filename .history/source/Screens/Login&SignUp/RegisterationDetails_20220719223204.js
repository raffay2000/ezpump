...
class RegistrationDetails extends Component{
    ...
    toggleCheck = () => {
        ...
        this.props.setIsCheck(!this.props.isCheck)
    }

    render() {
        const {email, phone, password,isCheck,setIsCheck} = this.props
        // const {isChecked} = this.state
        console.log(isCheck,setIsCheck)
        return (
            <View style={styles.main} >
                ...
                <View style={{flexDirection:"row", alignItems:"center", justifyContent:"center", width:"100%", marginTop:hp("3%")}} >
                    <BouncyCheckbox
                        ...
                        disableText={true}
                        onPress={()=>{this.toggleCheck(isCheck)}}
                        isChecked={isCheck}
                    />
