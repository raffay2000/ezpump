    ...
    Register_Now = async() => {
        ...
        if(
            ...
            !ImageSource == ""
                ...
                await this.props.setEmail(this.props.email);
                ...
                await this.props.registerStepTwo(
                    ImageSource,
                    // userType,email,password,phone,isCheck
                    );
            try {
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        registerStepTwo: (ImageSource,userType,email,password,phone,isCheck) => dispatch(registerStepTwo(ImageSource,userType,email,password,phone,isCheck)),
