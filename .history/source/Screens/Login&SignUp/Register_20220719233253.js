...
import { setDescription, setName, setUsername,registerStepTwo,setPhone,setEmail,setPassword,setWebsite } from "../../Redux/Action/AuthAction";
import {launchImageLibrary,} from 'react-native-image-picker';
 class Register extends Component{
    ...
    Register_Now = async() => {
        ...
        // const {email,password,phone} = this.props.route.params;
    ...
    render(){
        ...
        const {username, name, description,userType} = this.props;
        const {email,password,phone} = this.props.route.params;
