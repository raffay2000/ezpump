...
import { registerStepOne, setEmail, setPassword, setPhone,setIsAgree } from '../../Redux/Action/AuthAction';
import { connect } from 'react-redux';
import { phoneValidation, validateEmail } from '../../utils';
// import {} from "../../Redux/Reducer/AuthReducer";
...
class RegistrationDetails extends Component{
    ...
    onRegisterPress = async() => {
        ...
        const {email, phone, password,userType} = this.props;
    ...
    toggleCheck = () => {
        this.props.setIsAgree(!this.state.isChecked)
    }
...
function mapStateToProps(state) {
    return{
        ...
        // isChecked:state.authReducer.isAgree,
...
function mapDispatchToProps(dispatch) {
    return{
        ...
        // setIsAgree: (text)=> dispatch(setIsAgree(text)),
