...
import { setDescription, setName, setUsername,registerStepTwo,setPhone,setEmail,setPassword,setIsAgree,setWebsite,toggleUserType } from "../../Redux/Action/AuthAction";
 ...
 class Register extends Component{
    ...
    Register_Now = async() => {
        ...
        if(
            ...
            this.state.ImageSource == ""
                ...
                await this.props.setEmail(email);
                 await this.props.setPhone(phone);
                    ...
                    await this.props.setIsAgree(isCheck);
            ...
            await this.props.registerStepTwo(userType,ImageSource,isCheck);
            try {
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        registerStepTwo: (userType,ImageSource,isChecked) => dispatch(registerStepTwo(userType,ImageSource,isChecked)),
