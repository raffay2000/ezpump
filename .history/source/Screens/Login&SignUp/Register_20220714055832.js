          ...
          launchImageLibrary(options, (response) => {
            if (response.errorCode) {
              console.log('LaunchImageLibrary Error: ', response.errorMessage);
                ...
                // let source1 = response.assets;
                // let source2 = `assats:/jpeg;base64${source1}`;
                // console.log(source2)
                const source3 = { uri: 'data:image/jpeg;base64,' + response.assets[0] };
              this.setState({ImageSource:source3 })
        ...
        return(
           <ScrollView style={{flex:1, backgroundColor:primary, padding:hp("2%") }} >
                <View style={styles.main}> 
                    ...
                    {
                        this.state.ImageSource != "" ? (<Image source={this.state.ImageSource} style={{height:50,width:50}} />) : null
                    }
                     </View>
