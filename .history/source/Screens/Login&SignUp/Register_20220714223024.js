          ...
          launchImageLibrary(options, async(response) => {
            if (response.errorCode) {
              console.log('LaunchImageLibrary Error: ', response.errorMessage);
                ...
                let source1 = response.assets[0];
                // let source2 = `assats:/jpeg;base64${source1}`;
                // console.log(source2)
                // const source3 =  'data:image/jpeg;base64,' + response.assets[0] ;
                let base64 = await this.convertToBase64(source1);
                console.log(base64)
