...
import { registerStepOne, setEmail, setPassword, setPhone } from '../../Redux/Action/AuthAction';
...
class RegistrationDetails extends Component{
    ...
    onRegisterPress = () => {
        ...
        if( email == "" ||
            ...
            // return alert("done")
            return this.props.navigation.navigate("Register",{userType})
        }
    }
...
function mapDispatchToProps(dispatch) {
    return{
        ...
        registerStepOne: (email, phone, password) => dispatch(registerStepOne(email, phone, password)),
    }
}
