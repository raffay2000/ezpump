...
import { setDescription, setCompanyName, setUsername } from "../../Redux/Action/AuthAction";
    ...
    Register_Now = () => {
        ...
        if(
           ...
           this.setState({error:true})
            ...
            console.log(username, name, description, this.state.ImageSource, this.state.website_name, this.state.CompanyName, this.props.route.params.userType, this.props.route.params.isChecked, this.props.route.params.email, this.props.route.params.password, this.props.route.params.phone);
        }
    }
        ...
        return(
           <ScrollView style={{flex:1, backgroundColor:primary, padding:hp("2%") }} >
                <View style={styles.main}> 
                    ...
                    <InputComponent
                        value={name}
                        OnChangeText={(text)=> this.props.setCompanyName(text)}
                        otherProps= {{
...
const mapStateToProps = state => {
    return {
        company_name: state.authReducer.company_name,
...
const mapDispatchToProps = dispatch => {
    return {
        setCompanyName: (text) => dispatch(setCompanyName(text)),
