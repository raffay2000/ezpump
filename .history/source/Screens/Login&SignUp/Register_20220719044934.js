...
import { setDescription, setName, setUsername,registerStepTwo,setPhone,setEmail,setPassword,setIsAgree } from "../../Redux/Action/AuthAction";
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        registerStepTwo: (userType,website_name,ImageSource,isChecked) => dispatch(registerStepTwo(userType,website_name,ImageSource,isChecked)),
