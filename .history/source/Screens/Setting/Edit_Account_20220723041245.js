...
import { BASE_URL, fetchAPI } from '../../services';
...
var that;
 class Edit_Account extends React. Component {
    ...
    onEditPress=()=>{
        ...
        const {name, description, website, address, coverImage} = this.state;
        ...
        fetchAPI('post', 'user/update-profile', data, true)
    ...
    render(){
        ...
        const {email, phone_number, user_name,company_name} = user;
        const { description, coverImage, address, website, loading} = this.state;
