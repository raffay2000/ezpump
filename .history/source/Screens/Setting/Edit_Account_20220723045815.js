...
var that;
 class Edit_Account extends React. Component {
    ...
    constructor(props){
     ...
     componentDidMount(){
        that = this;
        const {name, description, website, address, cover_image,user_name,
            phone_number,
    ...
    onEditPress=()=>{
        ...
        const {name, description, website, coverImage,email,phone_number,company_name,user_name} = this.state;
    ...
    render(){
        ...
        // const {email} = user;
        const { email,phone_number, user_name,company_name,description, coverImage, website, loading} = this.state;
