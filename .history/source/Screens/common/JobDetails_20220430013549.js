...
import { black, primary, secondary, whit, white, white } from '../../assets/colors';
...
class Find_Job extends Component{
    ...
    renderSections = () => {
        if(this.props.ScreenType == "apply"){
            ...
            return(
                <Jop_InProcess
                    isCompany={this.state.Check_Type}
            ...
            return(
                <Job_Declined  onPress={()=> this.props.navigation.navigate("JobsScreen")}/>
            )
        }
