...
class Create_Job extends Component{
    ...
    onPostJobPress = () => {
        ...
        const {Add_1, Add_2, Description, Line, time, date, volume, map, stateValue, priceFrom, points, priceTo, pumpType, jobType, } = this.state;
        const {lat, lng} = map;
    ...
    render(){
        const {loading, Add_1, Add_2, Description, Line, mode, date, time, volume, jobType, pumpType, showDatePicker, termsModal, priceFrom, priceTo, stateValue, points } = this.state;
                    ...
                    <View style={styles.main}>
                        ...
                        <View style={[styles.row, {backgroundColor:'white', marginHorizontal:hp('2%'), marginVertical: hp('5%'), borderRadius: hp('2%'), height: hp('7.5%') }]}>
                            ...
                            <TextInput
                                ...
                                style={[styles.label,{fontFamily: bold, width:'50%',  height: hp('7.5%'), flex:1}]}
