...
class Create_Job extends Component{
    ...
    onPostJobPress = () => {
        ...
        if(Add_1 && Add_2 && Description && Line && time && date && volume && map && stateValue && priceFrom && priceTo && pumpType && jobType ){
    ...
    render(){
        const {Add_1, Add_2, Description, Line, mode, date, time, volume, jobType, pumpType, showDatePicker, termsModal, priceFrom, priceTo, stateValue } = this.state;
