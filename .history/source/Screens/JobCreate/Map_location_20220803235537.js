...
<GooglePlacesAutocomplete
 styles={{container:{
    ...
    region={region}
    onTouchMove={(e)=>{
      console.log("Touch Move",e.nativeEvent.changedTouches[0].touches[0]);
      // setRegion(region)
      // console.log("Touch Move",e.nativeEvent.changedTouches[0].pageX,e.nativeEvent.changedTouches[0].pageY);
      // setRegion({
    ...
    draggable
    // onTouchMove={(e)=>{
    //   console.log("this is Marker",e.nativeEvent.changedTouches[0].pageX,e.nativeEvent.changedTouches[0].pageY);
    // }}
    // onTouchMove={(e)=>{
    //   console.log("this is Marker",e.nativeEvent.changedTouches[0].pageX,e.nativeEvent.changedTouches[0].pageY);
    // }}
