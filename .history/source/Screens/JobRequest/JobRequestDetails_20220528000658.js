                ...
                <ScrollView showsVerticalScrollIndicator={false} >
                    ...
                    <View style={styles.First} >
                        ...
                        <View style={styles.miniContainer} >
                            ...
                            <Text style={[styles.Txt, {fontFamily:regular}]} >On Site {job.job_detail.date} {job.job_detail.time} </Text>
                            <View style={styles.ImageCont} >
                    ...
                    <View style={[styles.First, {flexDirection:"column",justifyContent:"center", padding:hp("1.25%"), height: 'auto'}]} >
                        <Text onPress={this.goToProfile} style={styles.Txt} > {job.job_detail.name} </Text>
                    ...
                    <View style={styles.First} >
                        <View style={styles.miniContainer} >
                            ...
                            <Text style={styles.Txt} >{job.job_type.name}</Text>
                        </View>
                        <View style={styles.miniContainer} >
                            <Text style={[styles.Txt, {fontFamily:regular}]} >Pump Type</Text>
                            <Text style={styles.Txt} >{job.pump_type.name}</Text>
                        </View>
                    </View>
                    ...
                    <View style={[styles.First, { borderBottomWidth:hp("0.2%"), flexDirection:'column', justifyContent: 'space-evenly'}]} >
                        ...
                        <Text style={[styles.txt,{ fontFamily:  bold, fontSize: hp('3%')}]}>{job.job_request.bid_amount}</Text>
                    </View>
