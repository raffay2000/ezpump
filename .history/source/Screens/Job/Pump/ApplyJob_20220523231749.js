                ...
                <ScrollView showsVerticalScrollIndicator={false} >
                    ...
                    {!isPending
                        ...
                        {eligible 
                            ...
                            <TouchableOpacity style={{alignItems: 'center', width: '35%', alignSelf: 'center', paddingVertical: hp('2%')}}>
                                <Text style={styles.Txt}>Buy Points</Text>
                                <AntDesign name={"pluscircle"} size={26} color={secondary} style={{marginTop: hp('2%')}}/>
                            </TouchableOpacity>
                            </>
                        }
