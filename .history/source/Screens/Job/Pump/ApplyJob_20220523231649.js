                ...
                <ScrollView showsVerticalScrollIndicator={false} >
                    ...
                    {!isPending
                        ...
                        {eligible 
                            ...
                            <TouchableOpacity style={{flexDirection:'row', alignItems: 'center', justifyContent: 'space-between', width: '35%', alignSelf: 'center', paddingVertical: hp('4%')}}>
                                <Text style={styles.Txt}>Buy Points</Text>
                                <AntDesign name={"pluscircle"} size={26} color={secondary} />
                            </TouchableOpacity>
                            </>
                        }
