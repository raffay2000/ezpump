...
class ApplyJob extends Component{
    ...
    onSendButtonPress = () => {
        ...
        // return alert(pumpID)
        return alert(!bidAmount && !proposal && !pumpID)
    ...
    render() {
        const {isPending, confirmModal, bidAmount, proposal, pumpID} = this.state;
