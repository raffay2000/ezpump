...
class Jobs extends Component{
    ...
    onFilterSubmitPress = (val) => {
        ...
        if(filterType=="Distance"){
            if(val == jobsFilter.distance.id) return;
            jobsFilter.distance.id = val;
        }else if(filterType == "Pump Type"){
            if(val == jobsFilter.pumpType.id) return
            jobsFilter.pumpType.id = val;
        }else{
            if(val == jobsFilter.jobType.id) return
            jobsFilter.jobType.id = val;
        }
