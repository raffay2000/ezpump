            ...
            <>
                ...
                <ScrollView showsVerticalScrollIndicator={false} >
                    ...
                    {this.props.ScreenType=="apply"
                        &&
                        <View style={[styles.First, { borderBottomWidth:hp("0.2%"),backgroundColor:'red'}]} >
                            <View style={[styles.miniContainer,{borderRightWidth:0}]} >
                                <Text style={[styles.Txt, {fontFamily:Regular}]} >10</Text>
                                <Text style={styles.Txt} >Required Points</Text>
                            </View>
                            <View style={styles.miniContainer} >
                                <Text style={[styles.Txt, {fontFamily:Bold, fontSize:hp('5%')}]} >80</Text>
