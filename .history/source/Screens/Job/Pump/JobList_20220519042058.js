...
class JobList extends Component{
            ...
            if(!loading){
                return(
                    <View style={{flex:1, justifyContent:'center', alignItems: 'center'}}>
                        <Text style={{fontSize:hp('2%'),fontFamily:regular, textAlign:'center', color:primary}}>No Prompts Available</Text>
                    </View>
                )
            }
        }
    ...
    render() {
        ...
        return (
            ...
            !success && !error ?
                <ActivityIndicator style={{ flex:1 }} color={primary} size="large" />
                :
                this.renderJobs()
