...
class Find_Job extends Component{
    ...
    renderSections = () => {
        if(this.props.ScreenType == "apply"){
            return(
                <>
                    <View style={[styles.First, {justifyContent:"center"}]} >
                        <TouchableOpacity style={styles.btn} onPress={this.ApplyForJob} >
                            <Text style={[styles.Txt, {color:White, marginTop:0}]} >APPLY THIS JOB</Text>
                        </TouchableOpacity>
                    </View>
                    
                    <View style={[styles.First, {flexDirection:"column",justifyContent:"center", padding:hp("1.25%")}]} >
            ...
            <>
                ...
                <ScrollView showsVerticalScrollIndicator={false} >
                    ...
                    <View style={styles.Map}>
                        <Image source={require("../../../Imagess/map.png")} style={{width:"100%", height:"100%"}} resizeMode="cover" />
                    </View>
