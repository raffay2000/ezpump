                    ...
                    {this.props.ScreenType=="apply"
                        ...
                        <View style={[styles.First, { borderBottomWidth:hp("0.2%")}]} >
                            <View style={[styles.miniContainer,{borderRightWidth:0}]} >
                                <Text style={[styles.Txt, {fontFamily:Bold, fontSize:hp('2.25%'),color: primary}]} >10</Text>
                                <Text style={[styles.Txt,{ fontFamily: Regular}]} >Required Points</Text>
                            </View>
                            <View style={styles.miniContainer} >
                                <Text style={[styles.Txt, {fontFamily:Bold, fontSize:hp('2.25%'),}]} >80</Text>
