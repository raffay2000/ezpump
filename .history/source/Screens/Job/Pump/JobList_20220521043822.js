...
class JobList extends Component{
    ...
    loadJobs = () => {
        ...
        if(!loading && !isListEnd){
            ...
            fetchAPI ('post', 'job/get-all-jobs', data, true, {page})
    ...
    //     this.checkType()
    // }
    navigate = (name, type="", jobDetails) => () => {
        // if(name == "FindJob"){
            // this.props._ScreenType(type)
            this.props.navigation.navigate("ApplyJob", {jobDetails});
        // }else{
                ...
                <FlatList
                    ...
                    renderItem={({item, index})=>(
                        <JobList_Component 
                            ...
                            JobType={item.job_type.type_name}
                            Distance={"40 Miles"}
                            Urgent={false}
