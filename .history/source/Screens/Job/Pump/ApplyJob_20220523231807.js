                ...
                <ScrollView showsVerticalScrollIndicator={false} >
                    ...
                    {!isPending
                        ...
                        {eligible 
                            ...
                            <TouchableOpacity style={{alignItems: 'center', width: '35%', alignSelf: 'center', paddingVertical: hp('1%')}}>
                                <Text style={styles.Txt}>Buy Points</Text>
                                <AntDesign name={"pluscircle"} size={32} color={secondary} style={{marginTop: hp('1%')}}/>
                            </TouchableOpacity>
                            </>
                        }
