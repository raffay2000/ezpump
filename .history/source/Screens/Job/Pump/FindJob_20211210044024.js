...
import { Bold, Regular } from '../../../ScreenComponent/Fonts';
            ...
            <>
                ...
                <ScrollView showsVerticalScrollIndicator={false} >
                    ...
                    {this.props.ScreenType=="apply"
                        ...
                        <View style={[styles.First, { borderBottomWidth:hp("0.2%"), flexDirection:'column', justifyContent: 'space-around'}]} >
                            <Text style={[styles.txt,{ fontFamily: Regular, color: primary}]}>Bid Range</Text>
                            <Text>$1200 - $1600</Text>
                            {/* <View style={[styles.miniContainer,{borderRightWidth:0}]} >
                                <Text style={[styles.Txt, {fontFamily:Bold, fontSize:hp('2.5%'),color: primary}]} >10</Text>
                                <Text style={[styles.Txt,{ fontFamily: Regular, color: primary}]} >Required Points</Text>
