...
class Account extends Component{
    ...
    renderContent = () => {
        const {type, description, phone, email, website, address, created_at, username, points} = this.props.user;
        return (
    ...
    renderImage(){
        const {cover_image} = this.props.user.cover_image;
        if(cover_image){
            return require(`../../assets/images/${cover_image}`);
        }else{
