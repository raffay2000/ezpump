...
class AddEditPump extends Component{
    ...
    onAddEditPump = () => {
        const {line, volume, availability, jobType, pumpType, type, description, stateValue} = this.state;
        // console.log(line, volume, availability,jobType, pumpType);
        if(line && volume && jobType && pumpType && type && description && stateValue){
    ...
    render() {
        const { type, availability, line, volume, jobType, pumpType, stateValue, description  } = this.state;
                    ...
                    <View style={styles.main} >
                        <ScrollView showsVerticalScrollIndicator={false} >
                            ...
                            <Button
                                color={secondary}
                                loading={loading}
                                text={type ? "ADD NEW PUMP" : "EDIT PUMP"}
                                textColor={white}
...
const mapDispatchToProps = dispatch => {
    return{
        addEditPump: (type, pump_id, line, volume, stateValue, jobType, pumpType, availability, description) => dispatch(addEditPump(type, pump_id, line, volume, stateValue, jobType, pumpType, availability, description))
    }
}
