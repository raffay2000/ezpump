...
class AddEditPump extends Component{
    ...
    onAddEditPump = () => {
        ...
        if(line && volume && availability && jobType && pumpType && type && description && stateValue){
...
const mapDispatchToProps = dispatch => {
    return{
        addEditPump: (type, line, volume, stateValue, jobType, pumpType, availability, description) => dispatch(addEditPump(type, line, volume, stateValue, jobType, pumpType, availability, description))
    }
}
