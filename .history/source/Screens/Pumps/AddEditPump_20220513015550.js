...
function Availability({OnChange, Day, isChecked}) {
    return(
...
class AddEditPump extends Component{
    ...
    render() {
        const { type, monday, tuesday, wednesday, thursday, friday, saturday, sunday, line, volume  } = this.state;
                ...
                <>
                    ...
                    <View style={styles.main} >
                        <ScrollView showsVerticalScrollIndicator={false} >
                            ...
                            <Availability Day={"Monday"} isChecked={monday} OnChange={()=> this.setState({monday: !monday})} />
                            <Availability Day={"Tuesday"} isChecked={tuesday} OnChange={()=> this.setState({tuesday: !tuesday})} />
                            <Availability Day={"Wednesday"} isChecked={wednesday} OnChange={()=> this.setState({wednesday: !wednesday})} />
                            <Availability Day={"Thursday"} isChecked={thursday} OnChange={()=> this.setState({thursday: !thursday})} />
                            <Availability Day={"Friday"} isChecked={friday} OnChange={()=> this.setState({friday: !friday})} />
                            <Availability Day={"Saturday"} isChecked={saturday} OnChange={()=> this.setState({saturday: !saturday})} />
                            <Availability Day={"Sunday"} isChecked={sunday} OnChange={()=> this.setState({sunday: !sunday})} />
