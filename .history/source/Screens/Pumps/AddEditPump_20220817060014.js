...
myHeaders.append("Authorization", "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..VBc1h5AcJGsPA33dfjBhq9RCzQKhhFxf4xZasmaIiwAhJnrdC57Xayp43abxQj7EM5UakJxgrJLluiMsF4WXU_IVk5P6-v2WxPidoeiwTezjgD5iCwEH1Ju91BMyqKVY8rj2L_59LcnDRZB3MsPfR6ZfylaV3mz7SbS0XHLngDV50jcuSvK2X9YJiQqMBWbaDa5Sxv6UKj_J2nWTaaTjdI8LcRfeC0YHNrtkrKqfKycQiSdv7ysmIxVD-e2GkDVGNB9QzPIazjuKLoLbdbKSX1LrpvPREcPqgK2m8EqhhmN8EA6csTcZD2XmQD2J8w4BlY36udFEiMOi2UpLIc3oFXB0-uvfqOUJPQoseuW3hwyNxhMv9J0hKlR62g6euMp5vkCpipVEO4YSpRqe9ZhVT8guEy-GKV9qc66AZK9urfdOqwM0uOhIburstnY9qOW1YucbHvVcNhjNUrKkvli7WY4rzblBtHuu8Inj9dpLY_RgtwCvStEzfcD2njA7SDv51UGoIwGfPEShORvwBskSjZbIoKZPhv_YGVoMjAPBW2Xx1IbsH5qnHlpC1E52Q7KKY68sp3LrbMo1sdfRfXN2o7a7GBZqvvTPhF5Yku_OJl8Jl7tOwLiBCFXyHP0y12ny0pXoCxrMF6Na3ABOLfEK6CyPfss1Idq2k7yDwi2ghP4");
...
fetch("http://ezpump.webdesignpreviews.com/api/get-pump-form-info", requestOptions)
  .then(response => response.json())
  .then(result => console.log("result",this.setState({showData: result})))
  .catch(error => console.log('error', error));
    ...
    render() {
        // console.log("JobType",this.props.alldata)

        const { id, availability, line, volume, jobType, pumpType, stateValue, name, description,showData  } = this.state;
        // const {monday, tuesday, wednesday, thursday, friday, saturday, sunday} = availability;
        const {  loading,deleteAlert,deleteLoading} = this.props;
                ...
                <>
                    ...
                    <View style={styles.main} >
                        <ScrollView showsVerticalScrollIndicator={false} >
                            ...
                            <DropDownComponent 
                                label={"State"}
                                data={showData.states}
                                selectedValue={showData.states.lenght}
                            />
                            <DropDownComponent 
                                label={"Job Type"}
                                data={showData.job_types}
                                selectedValue={showData.job_types.lenght}
                                onChange={val=>this.setState({jobType: val})}
                            />
                            <DropDownComponent 
                                label={"Pump Type"}
                                data={showData.pump_types}
                                selectedValue={showData.pump_types.lenght}
