...
class AddEditPump extends Component{
    ...
    componentDidMount(){
        ...
        if(id){ // edit
            ...
            const {line_length, m3, state, job_type_id, pump_type_id, description, availability} = pump;
    ...
    render() {
        const { id, deleteAlert, availability, line, volume, jobType, pumpType, stateValue, description  } = this.state;
        // const {monday, tuesday, wednesday, thursday, friday, saturday, sunday} = availability;
        const { jobTypes, pumpTypes, loading, deleteLoading } = this.props;
        return (
                <>
                    <AppHeader 
                    ...
                    <View style={styles.main} >
                        ...
                        <AwesomeAlert 
                            ...
                            contentContainerStyle={{width:hp("100%") , backgroundColor:"#FFFFFF", height: deleteLoading ? hp("26%"):hp("24%") ,}}
