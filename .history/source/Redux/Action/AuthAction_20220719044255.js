...
export const registerStepTwo = (password,phone5,userType,website,ImgSrc,is_agree) => {
    return function(dispatch, getState){
        const {name,username,description,phone,email} = getState().authReducer;
        console.log("this is in redux","email",email,"password", password,"phone", phone,"CompanyName",name,"userName",username,"description",description,"website",website,"is_agree",is_agree)
