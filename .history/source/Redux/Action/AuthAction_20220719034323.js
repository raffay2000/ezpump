...
export const registerStepOne = (isCheck) => {
    return function(dispatch, getState){
        ...
        .then(function (response) {
            ...
            registerStepOneDone(dispatch, "Registration Successful")
                return navigate('Register',{isCheck,email,password,phone,userType})
            }else{
            }
        })
        .catch(function (error) {
...
export const registerStepTwo = (email,password,phone5,userType,website,ImgSrc,is_agree) => {
    return function(dispatch, getState){
        const {name,username,description,phone} = getState().authReducer;
        console.log("email",email,"password", password,"phone", phone,"CompanyName",name,"userName",username,"description",description,"website",website,"is_agree",is_agree)
        console.log("userType",userType,"phone5",phone5,phone)
        dispatch({
        ...
        data.append('email', email);
        data.append('password', password);
        data.append('phone_number', phone5);
