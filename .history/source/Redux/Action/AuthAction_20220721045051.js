...
export const registerStepOne = (email,password,phone,userType) => {
    return function(dispatch, getState){
        ...
        .then(function (response) {
            ...
            registerStepOneDone(dispatch, "Some Problem Occurred inside server")
...
export const registerStepTwo = (ImgSrc,email
    // userType,password,phone,isCheck
    ) => {
    return function(dispatch, getState){
        const {name,username,description,website,userType,password,phone,isCheck} = getState().authReducer;
